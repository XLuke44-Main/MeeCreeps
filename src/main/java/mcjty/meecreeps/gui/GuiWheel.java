...
public class GuiWheel extends GuiScreen {
    ...
    private static final ResourceLocation backgroundInterdimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_interdimensional.png");
    private static final ResourceLocation hilightInterdimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_hilight_interdimensional.png");
    private static final ResourceLocation backgroundIntradimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_intradimensional.png");
    private static final ResourceLocation hilightIntradimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_hilight_intradimensional.png");
    private static final ResourceLocation backgroundExtradimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_extradimensional.png");
    private static final ResourceLocation hilightExtradimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_hilight_extradimensional.png");
    private static final ResourceLocation backgroundHyperdimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_hyperdimensional.png");
    private static final ResourceLocation hilightHyperdimensional =
            new ResourceLocation(MeeCreeps.MODID, "textures/gui/wheel_hilight_hyperdimensional.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mcjty.meecreeps.items.TransportSolutionType transportSolutionType = PortalGunItem.getTransportSolutionType(gun);

        ResourceLocation wheelBackground = getWheelBackground(transportSolutionType);
        ResourceLocation wheelHighlight = getWheelHighlight(transportSolutionType);
    ...
    private ResourceLocation getWheelBackground(mcjty.meecreeps.items.TransportSolutionType transportSolutionType) {
        switch (transportSolutionType) {
            case INTRADIMENSIONAL: return backgroundIntradimensional;
            case EXTRADIMENSIONAL: return backgroundExtradimensional;
            case HYPERDIMENSIONAL: return backgroundHyperdimensional;
            case INTERDIMENSIONAL:
            default: return backgroundInterdimensional;
        }
    }

    private ResourceLocation getWheelHighlight(mcjty.meecreeps.items.TransportSolutionType transportSolutionType) {
        switch (transportSolutionType) {
            case INTRADIMENSIONAL: return hilightIntradimensional;
            case EXTRADIMENSIONAL: return hilightExtradimensional;
            case HYPERDIMENSIONAL: return hilightHyperdimensional;
            case INTERDIMENSIONAL:
            default: return hilightInterdimensional;
        }
    }
    ...
    private void drawDestinationInfo(int ring, int slot) {
        ...
        if (PortalGunItem.isIntradimensionalActive(gun)
            ...
            drawCenteredString(
                    fontRenderer,
                    PortalGunItem.INTRADIMENSIONAL_DIMENSION_ERROR,
                    centerX,
                    guiTop + HEIGHT + 18,
                    0xFF55AAFF
            );
