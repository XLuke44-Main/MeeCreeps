...
public class GuiAskCoords extends GuiScreen {
    ...
    @Override public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRenderer, "Custom Destination: X;Y;Z [;DIMID|;DIRECTION|;DIRECTION;DIMID]", width / 2, height / 2 - 65, 0xFFFFFF);
    ...
    private String validateSyntax(String input) {
        ...
        try {
            ...
            if (parts.length == 4) {
                ...
                if (fourth.length() != 1 || "UDWENSudwens".indexOf(fourth.charAt(0)) < 0) Integer.parseInt(fourth);
