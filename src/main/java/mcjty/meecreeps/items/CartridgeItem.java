...
public class CartridgeItem extends Item {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        Collections.addAll(tooltip, StringUtils.split(I18n.format("message.meecreeps.tooltip." + getTransportSolutionType(stack).getName() + "_cartridge_item", Integer.toString(getCharge(stack))), "\n"));
    }
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        return I18n.format("item.meecreeps." + prefix + type.getName() + "_cartridge.name");
    }
