...
public class InsertCartridgeFactory implements IRecipeFactory {
    ...
    public static class InsertCartridgeRecipe extends ShapelessRecipes {
        ...
        /**
         * Match the two required item types by registry item, intentionally ignoring
         * custom NBT such as an anvil-applied display name on the empty Portal Gun.
         * This keeps renamed guns craftable with cartridges while preserving all of
         * their existing NBT on the crafted result.
         */
        @Override
        ...
        public ItemStack getCraftingResult(@Nonnull InventoryCrafting var1) {
            ...
            if (!cartridge.isEmpty()) {
                ...
                PortalGunItem.setBlueFluid(newOutput, CartridgeItem.isBlueFluid(cartridge));
            }
