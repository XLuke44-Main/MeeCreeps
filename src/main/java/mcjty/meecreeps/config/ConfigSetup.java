...
public class ConfigSetup {
    ...
    public static ConfigSpec.IntValue interdimensionalMaxCharge;
    public static ConfigSpec.IntValue interdimensionalRefillAmount;
    public static ConfigSpec.IntValue intradimensionalMaxCharge;
    public static ConfigSpec.IntValue intradimensionalRefillAmount;
    public static ConfigSpec.IntValue extradimensionalMaxCharge;
    public static ConfigSpec.IntValue extradimensionalRefillAmount;
    public static ConfigSpec.IntValue hyperdimensionalMaxCharge;
    public static ConfigSpec.IntValue hyperdimensionalRefillAmount;
    ...
    static {
        ...
        interdimensionalMaxCharge = SERVER_BUILDER
                .comment("Maximum charge in an interdimensional portal gun/cartridge")
                .defineInRange("interdimensionalMaxCharge", 100, 1, 1000000);
        interdimensionalRefillAmount = SERVER_BUILDER
                .comment("Charges added by one ender pearl to the interdimensional transport solution")
                .defineInRange("interdimensionalRefillAmount", 100, 1, 1000000);
        intradimensionalMaxCharge = SERVER_BUILDER
                .comment("Maximum charge in an intradimensional portal gun/cartridge")
                .defineInRange("intradimensionalMaxCharge", 50, 1, 1000000);
        intradimensionalRefillAmount = SERVER_BUILDER
                .comment("Charges added by one water container to the intradimensional transport solution")
                .defineInRange("intradimensionalRefillAmount", 50, 1, 1000000);
        extradimensionalMaxCharge = SERVER_BUILDER
                .comment("Maximum charge in an extradimensional portal gun/cartridge")
                .defineInRange("extradimensionalMaxCharge", 200, 1, 1000000);
        extradimensionalRefillAmount = SERVER_BUILDER
                .comment("Charges added by one golden ingot to the extradimensional transport solution")
                .defineInRange("extradimensionalRefillAmount", 200, 1, 1000000);
        hyperdimensionalMaxCharge = SERVER_BUILDER
                .comment("Maximum charge in a hyperdimensional portal gun/cartridge")
                .defineInRange("hyperdimensionalMaxCharge", 400, 1, 1000000);
        hyperdimensionalRefillAmount = SERVER_BUILDER
                .comment("Charges added by one redstone to the hyperdimensional transport solution")
                .defineInRange("hyperdimensionalRefillAmount", 400, 1, 1000000);
