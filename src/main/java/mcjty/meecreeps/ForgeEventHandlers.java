...
public class ForgeEventHandlers {
    ...
    public void onWorldTick(TickEvent.ServerTickEvent event) {
        ...
        // Harvest registrations are transient. Drop any registration whose action no longer
        // exists so a failed/cancelled action cannot leave stale positions behind.
