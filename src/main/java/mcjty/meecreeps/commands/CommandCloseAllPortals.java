...
/**
 * Forcefully removes every currently loaded MeeCreeps portal from every server dimension.
 * Restricted to command permission level 2 (operator-level command access).
 */
public class CommandCloseAllPortals implements ICommand {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        for (WorldServer world : server.worlds) {
            ...
            // Copy first because killPortal() removes the block/tile entity from the world.
