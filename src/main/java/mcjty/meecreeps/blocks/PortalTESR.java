...
public class PortalTESR extends TileEntitySpecialRenderer<PortalTileEntity> {
    ...
    public void render(PortalTileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        boolean ordinaryPortal = te.getSpawnerPos() == null;
        if (!ordinaryPortal) {
    ...
    public static void renderSpawnerPortal(PortalTileEntity te, double x, double y, double z) {
        ...
        try {
            ...
            final double spawnerPlane = 0.0075D;
            final double portalGap = 0.005D;
            double renderOx = face.ox;
            double renderOy = face.oy;
            double renderOz = face.oz;
            switch (te.getPortalSide()) {
                case NORTH:
                    renderOz = 1.0D - spawnerPlane - portalGap;
                    break;
                case SOUTH:
                    renderOz = spawnerPlane + portalGap;
                    break;
                case EAST:
                    renderOx = spawnerPlane + portalGap;
                    break;
                case WEST:
                    renderOx = 1.0D - spawnerPlane - portalGap;
                    break;
                default:
                    break;
            }
