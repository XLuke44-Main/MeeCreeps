...
public class KeyInputHandler {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        ...
        // KeyBinding.isPressed() keeps a queued press alive until it is consumed. That means a
        // key pressed without the portal gun equipped can fire later when the player selects the
        // gun. Only handle these bindings for the actual key-down event that caused the callback.
